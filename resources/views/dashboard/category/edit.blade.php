...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Edit Data Kategori Wisata</h1>
</div>
...
<div class="col-lg-7">
      <form method="post" action="/dashboard-category/{{ $data->destination_category_id }}" class="mb-5" enctype="multipart/form-data">
        @method('put')
        @csrf
      <div class="mb-3">
        ...
        is-invalid
        @enderror" id="destination_category_name" name="destination_category_name"  value="{{ old('destination_category_name', $data->destination_category_name) }} ">
        
        @error('destination_category_name')
